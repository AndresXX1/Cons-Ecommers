    ...
    <div className="relative w-full flex items-center justify-center">
      <input
        ...
        className={cn(
          ...
          } rounded-[8px] h-[50px] p-3 my-2 w-full px-[18px] border-gray-400 leading-[100%] tracking-[-0.16px] font-book focus:border-padelink-yellow focus:ring-0 bg-white disabled:bg-black text-argenpesos-textos`,
          className
        )}
        name={name}
        id={id}
      ...
      <span
        ...
        className={`absolute -left-3 mx-6 px-2 transition duration-200 cursor-text text-argenpesos-gray3 text-[12px] font-book leading-[100%] ${
          focused || value
            ? "input-text text-argenpesos-gray3 text-[12px] font-book leading-[100%]"
            : ""
        }`}
      >
        {label}
